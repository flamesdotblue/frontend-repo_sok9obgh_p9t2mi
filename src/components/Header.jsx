      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="h-16 flex items-center justify-between">
          <a href="/" className="group inline-flex items-center gap-2 text-white font-semibold">
            <span className="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-tr from-indigo-600 to-violet-500 text-white shadow shadow-indigo-600/20">
              <Rocket className="h-5 w-5" />
            </span>
            <span className="text-lg tracking-tight">Nebula Executor</span>
          </a>
          <nav className="hidden sm:flex items-center gap-6 text-sm text-slate-300">
            {[
              ...
              <a key={link.href} href={link.href} className="relative hover:text-white transition-colors group">
                ...
                <span className="pointer-events-none absolute -bottom-1 left-0 h-px w-0 bg-gradient-to-r from-indigo-500 to-fuchsia-500 transition-all duration-300 group-hover:w-full" />
              </a>
            ))}
          </nav>
